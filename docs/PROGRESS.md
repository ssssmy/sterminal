...
| **P1 核心增强** | SFTP文件管理、命令片段、端口转发、设置完善、云同步对接 | 🔧 部分完成 |
| **P2 进阶功能** | SSH密钥管理、已知主机、Vault密钥库、回放器、日志审计 | ⏳ 待开发 |
...
- [ ] 账户设置：修改密码、退出登录、删除账号、头像上传（等云同步对接）
- [ ] 同步设置：同步状态、上次同步时间、手动触发同步（等云同步对接）
