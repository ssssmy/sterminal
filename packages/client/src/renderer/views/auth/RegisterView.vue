  ...
  <div class="register-page">
    ...
    <div class="register-brand">
      ...
      <div class="register-brand__features">
        ...
        <div class="register-brand__feature">
          <div class="register-brand__feature-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
          </div>
          <div class="register-brand__feature-text">
            <span class="register-brand__feature-title">{{ t('loginView.featEncTitle') }}</span>
            <span class="register-brand__feature-desc">{{ t('loginView.featEncDesc') }}</span>
          </div>
        </div>
      </div>
    </div>
